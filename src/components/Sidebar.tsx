            ...
            <ul className="ml-4">
                    ...
                    >
                        {({ isActive }) => (
                            <div className="flex gap-4">
                                <MdOutlineDashboard className="group-hover:text-electric-lime transition-colors delay-75" size={20} color={`${isActive ? '#CFFF04' : ''}`} />
                ...
                <li>
                    ...
                    >
                        {({ isActive }) => (
                            <div className="flex gap-4">
                                <FaMoneyBillTransfer className="group-hover:text-electric-lime transition-colors delay-75" size={20} color={`${isActive ? '#CFFF04' : ''}`} />
